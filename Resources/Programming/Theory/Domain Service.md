...
*   **Взаимодействие с внешними ресурсами**. Если правило предметной области требует обращения к [[Repository (pattern)|репозиторию]], внешнему API или другому сервису, эта логика размещается в сервисе, а не в сущности.
