---
updated_at: 2026-02-12T17:45:36.228+10:00
---
...
2.  **Задержка первого обращения ([[First Use Penalty|штраф первого использования]])**. В момент первого вызова система вынуждена выполнить отложенную операцию, что может вызвать непредсказуемую задержку в ответе пользователю.
