...
1.  **Ядро приложения ([[Application Core|application core]])**. Внутренний слой содержит [[Entity|сущности]], [[Value Object|объекты-значения]], [[Aggregate|агрегаты]], [[Domain Service|сервисы предметной области]] и [[Repository (pattern)|репозитории]] (в виде интерфейсов). Ядро не имеет внешних зависимостей.
