...
| LSS Parameter                     | Value       |
| --------------------------------- | ----------- |
| Cost per 1 Unit                   | Cr150       |
| Consumtion (base) per person      | 1 per day   |
| Consumtion (Low birth) per person | 0.1 per day |
| Storage Ton of Hull               | 4 Units     |
| Storage per Ton of Cargo          | 100 Units   |
