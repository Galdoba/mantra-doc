...
2.  **Управление жизненным циклом**. Сущности требуют создания, хранения, поиска и удаления; это влечёт необходимость [[Repository (pattern)|репозиториев]] и инфраструктурного кода, отсутствующего у объектов-значений.
...
6.  **Использование репозиториев ([[Repository (pattern)|repository]])**. Каждая корневая сущность имеет соответствующий репозиторий, инкапсулирующий логику сохранения, поиска и удаления. Репозитории предоставляют коллекционно-подобный интерфейс и скрывают детали хранения.
