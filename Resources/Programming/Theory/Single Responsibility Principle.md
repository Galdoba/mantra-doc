---
updated_at: 2026-02-12T15:05:03.960+10:00
---
...
2.  **Риск избыточного дробления ([[Over-Engineering|over-engineering]])**. Чрезмерное следование принципу приводит к созданию множества мельчайших классов, каждый из которых содержит одну-две строки кода. Это увеличивает сложность навигации и понимания общей картины.
