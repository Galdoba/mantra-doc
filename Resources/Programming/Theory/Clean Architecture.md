...
6.  **[[Repository (pattern)|Репозиторий]] как порт для доступа к данным**. Внутренний круг определяет интерфейс репозитория; внешний круг реализует его с использованием конкретной СУБД или ORM.
