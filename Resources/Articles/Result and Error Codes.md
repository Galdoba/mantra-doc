...
Many of the routines in the SQLite [C-language Interface](https://www.sqlite.org/c3ref/intro.html) return numeric result codes indicating either success or failure, and in the event of a failure, providing some idea of the cause of the failure. This document strives to explain what each of those numeric result codes means.
...
For historic compatibility, the C-language interfaces return primary result codes by default. The extended result code for the most recent error can be retrieved using the [sqlite3_extended_errcode()](https://www.sqlite.org/c3ref/errcode.html) interface. The [sqlite3_extended_result_codes()](https://www.sqlite.org/c3ref/extended_result_codes.html) interface can be used to put a [database connection](https://www.sqlite.org/c3ref/sqlite3.html) into a mode where it returns the extended result codes instead of the primary result codes.

## 3. Definitions

All result codes are integers. Symbolic names for all result codes are created using "#define" macros in the sqlite3.h header file. There are separate sections in the sqlite3.h header file for the [result code definitions](https://www.sqlite.org/c3ref/c_abort.html) and the [extended result code definitions](https://www.sqlite.org/c3ref/c_abort_rollback.html).
...
The 31 result codes are [defined in sqlite3.h](https://www.sqlite.org/c3ref/c_abort.html) and are listed in alphabetical order below:

- [SQLITE_ABORT (4)](https://www.sqlite.org/rescode.html#abort)
- [SQLITE_AUTH (23)](https://www.sqlite.org/rescode.html#auth)
- [SQLITE_BUSY (5)](https://www.sqlite.org/rescode.html#busy)
- [SQLITE_CANTOPEN (14)](https://www.sqlite.org/rescode.html#cantopen)
- [SQLITE_CONSTRAINT (19)](https://www.sqlite.org/rescode.html#constraint)
- [SQLITE_CORRUPT (11)](https://www.sqlite.org/rescode.html#corrupt)
- [SQLITE_DONE (101)](https://www.sqlite.org/rescode.html#done)
- [SQLITE_EMPTY (16)](https://www.sqlite.org/rescode.html#empty)
- [SQLITE_ERROR (1)](https://www.sqlite.org/rescode.html#error)
- [SQLITE_FORMAT (24)](https://www.sqlite.org/rescode.html#format)
- [SQLITE_FULL (13)](https://www.sqlite.org/rescode.html#full)
- [SQLITE_INTERNAL (2)](https://www.sqlite.org/rescode.html#internal)
- [SQLITE_INTERRUPT (9)](https://www.sqlite.org/rescode.html#interrupt)
- [SQLITE_IOERR (10)](https://www.sqlite.org/rescode.html#ioerr)
- [SQLITE_LOCKED (6)](https://www.sqlite.org/rescode.html#locked)
- [SQLITE_MISMATCH (20)](https://www.sqlite.org/rescode.html#mismatch)
- [SQLITE_MISUSE (21)](https://www.sqlite.org/rescode.html#misuse)
- [SQLITE_NOLFS (22)](https://www.sqlite.org/rescode.html#nolfs)
- [SQLITE_NOMEM (7)](https://www.sqlite.org/rescode.html#nomem)
- [SQLITE_NOTADB (26)](https://www.sqlite.org/rescode.html#notadb)
- [SQLITE_NOTFOUND (12)](https://www.sqlite.org/rescode.html#notfound)
- [SQLITE_NOTICE (27)](https://www.sqlite.org/rescode.html#notice)
- [SQLITE_OK (0)](https://www.sqlite.org/rescode.html#ok)
- [SQLITE_PERM (3)](https://www.sqlite.org/rescode.html#perm)
- [SQLITE_PROTOCOL (15)](https://www.sqlite.org/rescode.html#protocol)
- [SQLITE_RANGE (25)](https://www.sqlite.org/rescode.html#range)
- [SQLITE_READONLY (8)](https://www.sqlite.org/rescode.html#readonly)
- [SQLITE_ROW (100)](https://www.sqlite.org/rescode.html#row)
- [SQLITE_SCHEMA (17)](https://www.sqlite.org/rescode.html#schema)
- [SQLITE_TOOBIG (18)](https://www.sqlite.org/rescode.html#toobig)
- [SQLITE_WARNING (28)](https://www.sqlite.org/rescode.html#warning)

## 5. Extended Result Code List

The 74 extended result codes are [defined in sqlite3.h](https://www.sqlite.org/c3ref/c_abort_rollback.html) and are listed in alphabetical order below:

- [SQLITE_ABORT_ROLLBACK (516)](https://www.sqlite.org/rescode.html#abort_rollback)
- [SQLITE_AUTH_USER (279)](https://www.sqlite.org/rescode.html#auth_user)
- [SQLITE_BUSY_RECOVERY (261)](https://www.sqlite.org/rescode.html#busy_recovery)
- [SQLITE_BUSY_SNAPSHOT (517)](https://www.sqlite.org/rescode.html#busy_snapshot)
- [SQLITE_BUSY_TIMEOUT (773)](https://www.sqlite.org/rescode.html#busy_timeout)
- [SQLITE_CANTOPEN_CONVPATH (1038)](https://www.sqlite.org/rescode.html#cantopen_convpath)
- [SQLITE_CANTOPEN_DIRTYWAL (1294)](https://www.sqlite.org/rescode.html#cantopen_dirtywal)
- [SQLITE_CANTOPEN_FULLPATH (782)](https://www.sqlite.org/rescode.html#cantopen_fullpath)
- [SQLITE_CANTOPEN_ISDIR (526)](https://www.sqlite.org/rescode.html#cantopen_isdir)
- [SQLITE_CANTOPEN_NOTEMPDIR (270)](https://www.sqlite.org/rescode.html#cantopen_notempdir)
- [SQLITE_CANTOPEN_SYMLINK (1550)](https://www.sqlite.org/rescode.html#cantopen_symlink)
- [SQLITE_CONSTRAINT_CHECK (275)](https://www.sqlite.org/rescode.html#constraint_check)
- [SQLITE_CONSTRAINT_COMMITHOOK (531)](https://www.sqlite.org/rescode.html#constraint_commithook)
- [SQLITE_CONSTRAINT_DATATYPE (3091)](https://www.sqlite.org/rescode.html#constraint_datatype)
- [SQLITE_CONSTRAINT_FOREIGNKEY (787)](https://www.sqlite.org/rescode.html#constraint_foreignkey)
- [SQLITE_CONSTRAINT_FUNCTION (1043)](https://www.sqlite.org/rescode.html#constraint_function)
- [SQLITE_CONSTRAINT_NOTNULL (1299)](https://www.sqlite.org/rescode.html#constraint_notnull)
- [SQLITE_CONSTRAINT_PINNED (2835)](https://www.sqlite.org/rescode.html#constraint_pinned)
- [SQLITE_CONSTRAINT_PRIMARYKEY (1555)](https://www.sqlite.org/rescode.html#constraint_primarykey)
- [SQLITE_CONSTRAINT_ROWID (2579)](https://www.sqlite.org/rescode.html#constraint_rowid)
- [SQLITE_CONSTRAINT_TRIGGER (1811)](https://www.sqlite.org/rescode.html#constraint_trigger)
- [SQLITE_CONSTRAINT_UNIQUE (2067)](https://www.sqlite.org/rescode.html#constraint_unique)
- [SQLITE_CONSTRAINT_VTAB (2323)](https://www.sqlite.org/rescode.html#constraint_vtab)
- [SQLITE_CORRUPT_INDEX (779)](https://www.sqlite.org/rescode.html#corrupt_index)
- [SQLITE_CORRUPT_SEQUENCE (523)](https://www.sqlite.org/rescode.html#corrupt_sequence)
- [SQLITE_CORRUPT_VTAB (267)](https://www.sqlite.org/rescode.html#corrupt_vtab)
- [SQLITE_ERROR_MISSING_COLLSEQ (257)](https://www.sqlite.org/rescode.html#error_missing_collseq)
- [SQLITE_ERROR_RETRY (513)](https://www.sqlite.org/rescode.html#error_retry)
- [SQLITE_ERROR_SNAPSHOT (769)](https://www.sqlite.org/rescode.html#error_snapshot)
- [SQLITE_IOERR_ACCESS (3338)](https://www.sqlite.org/rescode.html#ioerr_access)
- [SQLITE_IOERR_AUTH (7178)](https://www.sqlite.org/rescode.html#ioerr_auth)
- [SQLITE_IOERR_BEGIN_ATOMIC (7434)](https://www.sqlite.org/rescode.html#ioerr_begin_atomic)
- [SQLITE_IOERR_BLOCKED (2826)](https://www.sqlite.org/rescode.html#ioerr_blocked)
- [SQLITE_IOERR_CHECKRESERVEDLOCK (3594)](https://www.sqlite.org/rescode.html#ioerr_checkreservedlock)
- [SQLITE_IOERR_CLOSE (4106)](https://www.sqlite.org/rescode.html#ioerr_close)
- [SQLITE_IOERR_COMMIT_ATOMIC (7690)](https://www.sqlite.org/rescode.html#ioerr_commit_atomic)
- [SQLITE_IOERR_CONVPATH (6666)](https://www.sqlite.org/rescode.html#ioerr_convpath)
- [SQLITE_IOERR_CORRUPTFS (8458)](https://www.sqlite.org/rescode.html#ioerr_corruptfs)
- [SQLITE_IOERR_DATA (8202)](https://www.sqlite.org/rescode.html#ioerr_data)
- [SQLITE_IOERR_DELETE (2570)](https://www.sqlite.org/rescode.html#ioerr_delete)
- [SQLITE_IOERR_DELETE_NOENT (5898)](https://www.sqlite.org/rescode.html#ioerr_delete_noent)
- [SQLITE_IOERR_DIR_CLOSE (4362)](https://www.sqlite.org/rescode.html#ioerr_dir_close)
- [SQLITE_IOERR_DIR_FSYNC (1290)](https://www.sqlite.org/rescode.html#ioerr_dir_fsync)
- [SQLITE_IOERR_FSTAT (1802)](https://www.sqlite.org/rescode.html#ioerr_fstat)
- [SQLITE_IOERR_FSYNC (1034)](https://www.sqlite.org/rescode.html#ioerr_fsync)
- [SQLITE_IOERR_GETTEMPPATH (6410)](https://www.sqlite.org/rescode.html#ioerr_gettemppath)
- [SQLITE_IOERR_LOCK (3850)](https://www.sqlite.org/rescode.html#ioerr_lock)
- [SQLITE_IOERR_MMAP (6154)](https://www.sqlite.org/rescode.html#ioerr_mmap)
- [SQLITE_IOERR_NOMEM (3082)](https://www.sqlite.org/rescode.html#ioerr_nomem)
- [SQLITE_IOERR_RDLOCK (2314)](https://www.sqlite.org/rescode.html#ioerr_rdlock)
- [SQLITE_IOERR_READ (266)](https://www.sqlite.org/rescode.html#ioerr_read)
- [SQLITE_IOERR_ROLLBACK_ATOMIC (7946)](https://www.sqlite.org/rescode.html#ioerr_rollback_atomic)
- [SQLITE_IOERR_SEEK (5642)](https://www.sqlite.org/rescode.html#ioerr_seek)
- [SQLITE_IOERR_SHMLOCK (5130)](https://www.sqlite.org/rescode.html#ioerr_shmlock)
- [SQLITE_IOERR_SHMMAP (5386)](https://www.sqlite.org/rescode.html#ioerr_shmmap)
- [SQLITE_IOERR_SHMOPEN (4618)](https://www.sqlite.org/rescode.html#ioerr_shmopen)
- [SQLITE_IOERR_SHMSIZE (4874)](https://www.sqlite.org/rescode.html#ioerr_shmsize)
- [SQLITE_IOERR_SHORT_READ (522)](https://www.sqlite.org/rescode.html#ioerr_short_read)
- [SQLITE_IOERR_TRUNCATE (1546)](https://www.sqlite.org/rescode.html#ioerr_truncate)
- [SQLITE_IOERR_UNLOCK (2058)](https://www.sqlite.org/rescode.html#ioerr_unlock)
- [SQLITE_IOERR_VNODE (6922)](https://www.sqlite.org/rescode.html#ioerr_vnode)
- [SQLITE_IOERR_WRITE (778)](https://www.sqlite.org/rescode.html#ioerr_write)
- [SQLITE_LOCKED_SHAREDCACHE (262)](https://www.sqlite.org/rescode.html#locked_sharedcache)
- [SQLITE_LOCKED_VTAB (518)](https://www.sqlite.org/rescode.html#locked_vtab)
- [SQLITE_NOTICE_RECOVER_ROLLBACK (539)](https://www.sqlite.org/rescode.html#notice_recover_rollback)
- [SQLITE_NOTICE_RECOVER_WAL (283)](https://www.sqlite.org/rescode.html#notice_recover_wal)
- [SQLITE_OK_LOAD_PERMANENTLY (256)](https://www.sqlite.org/rescode.html#ok_load_permanently)
- [SQLITE_READONLY_CANTINIT (1288)](https://www.sqlite.org/rescode.html#readonly_cantinit)
- [SQLITE_READONLY_CANTLOCK (520)](https://www.sqlite.org/rescode.html#readonly_cantlock)
- [SQLITE_READONLY_DBMOVED (1032)](https://www.sqlite.org/rescode.html#readonly_dbmoved)
- [SQLITE_READONLY_DIRECTORY (1544)](https://www.sqlite.org/rescode.html#readonly_directory)
- [SQLITE_READONLY_RECOVERY (264)](https://www.sqlite.org/rescode.html#readonly_recovery)
- [SQLITE_READONLY_ROLLBACK (776)](https://www.sqlite.org/rescode.html#readonly_rollback)
- [SQLITE_WARNING_AUTOINDEX (284)](https://www.sqlite.org/rescode.html#warning_autoindex)

## 6. Result Code Meanings

The meanings for all 105 result code values are shown below, in numeric order.
...
This result code might be caused by a bug in SQLite. However, [application-defined SQL functions](https://www.sqlite.org/appfunc.html) or [virtual tables](https://www.sqlite.org/vtab.html), or [VFSes](https://www.sqlite.org/vfs.html), or other extensions can also cause this result code to be returned, so the problem might not be the fault of the core SQLite.
...
The SQLITE_ABORT result code indicates that an operation was aborted prior to completion, usually by application request. See also: [SQLITE_INTERRUPT](https://www.sqlite.org/rescode.html#interrupt).
...
3. SQLITE_NOTFOUND can be returned by [sqlite3_vtab_rhs_value()](https://www.sqlite.org/c3ref/vtab_rhs_value.html) to indicate that the right-hand operand of a constraint is not available to the [xBestIndex method](https://www.sqlite.org/vtab.html#xbestindex) that made the call.
...
The SQLITE_TOOBIG error code can also result when an oversized SQL statement is passed into one of the [sqlite3_prepare_v2()](https://www.sqlite.org/c3ref/prepare.html) interfaces. The maximum length of an SQL statement defaults to a similar value of 1,000,000,000 bytes. The maximum SQL statement length can be set at compile-time using [SQLITE_MAX_SQL_LENGTH](https://www.sqlite.org/limits.html#max_sql_length) or at run-time using [sqlite3_limit](https://www.sqlite.org/c3ref/limit.html)(db,[SQLITE_LIMIT_SQL_LENGTH](https://www.sqlite.org/c3ref/c_limit_attached.html#sqlitelimitsqllength),...).
...
The SQLITE_IOERR_TRUNCATE error code is an [extended error code](https://www.sqlite.org/rescode.html#pve) for [SQLITE_IOERR](https://www.sqlite.org/rescode.html#ioerr) indicating an I/O error in the [VFS](https://www.sqlite.org/vfs.html) layer while trying to changes the size of a file using the xTruncate method of the [sqlite3_io_methods](https://www.sqlite.org/c3ref/io_methods.html) object.
...
The SQLITE_IOERR_UNLOCK error code is an [extended error code](https://www.sqlite.org/rescode.html#pve) for [SQLITE_IOERR](https://www.sqlite.org/rescode.html#ioerr) indicating an I/O error within the xUnlock method on the [sqlite3_io_methods](https://www.sqlite.org/c3ref/io_methods.html) object.
...
The SQLITE_IOERR_RDLOCK error code is an [extended error code](https://www.sqlite.org/rescode.html#pve) for [SQLITE_IOERR](https://www.sqlite.org/rescode.html#ioerr) indicating an I/O error within the xLock method on the [sqlite3_io_methods](https://www.sqlite.org/c3ref/io_methods.html) object while trying to obtain a read lock.
...
The SQLITE_IOERR_DELETE error code is an [extended error code](https://www.sqlite.org/rescode.html#pve) for [SQLITE_IOERR](https://www.sqlite.org/rescode.html#ioerr) indicating an I/O error within the xDelete method on the [sqlite3_vfs](https://www.sqlite.org/c3ref/vfs.html) object.
...
The SQLITE_IOERR_BEGIN_ATOMIC error code indicates that the underlying operating system reported an error on the [SQLITE_FCNTL_BEGIN_ATOMIC_WRITE](https://www.sqlite.org/c3ref/c_fcntl_begin_atomic_write.html#sqlitefcntlbeginatomicwrite) file-control. This only comes up when [SQLITE_ENABLE_ATOMIC_WRITE](https://www.sqlite.org/compile.html#enable_atomic_write) is enabled and the database is hosted on a filesystem that supports atomic writes.
...
The SQLITE_IOERR_ROLLBACK_ATOMIC error code indicates that the underlying operating system reported an error on the [SQLITE_FCNTL_ROLLBACK_ATOMIC_WRITE](https://www.sqlite.org/c3ref/c_fcntl_begin_atomic_write.html#sqlitefcntlrollbackatomicwrite) file-control. This only comes up when [SQLITE_ENABLE_ATOMIC_WRITE](https://www.sqlite.org/compile.html#enable_atomic_write) is enabled and the database is hosted on a filesystem that supports atomic writes.

### (8202) SQLITE_IOERR_DATA

The SQLITE_IOERR_DATA error code is an [extended error code](https://www.sqlite.org/rescode.html#pve) for [SQLITE_IOERR](https://www.sqlite.org/rescode.html#ioerr) used only by the [checksum VFS shim](https://www.sqlite.org/cksumvfs.html) to indicate that the checksum on a page of the database file is incorrect.
