...
1.  **Вынесение состояния во внешние хранилища**. Сессионные данные, кэши и долговременное состояние размещаются в специализированных системах: [Redis], [Memcached], реляционных базах данных. Это превращает сервис в «чистый» процессор запросов.
