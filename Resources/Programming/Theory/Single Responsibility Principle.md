...
5.  **[[Repository (pattern)|Репозиторий]] как отделение доступа к данным**. Логика сохранения и извлечения объектов выделяется в отдельные классы, не смешиваясь с бизнес-правилами сущностей.
